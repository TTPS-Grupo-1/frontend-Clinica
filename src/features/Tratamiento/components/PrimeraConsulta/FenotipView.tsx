    ...
    <div className="rounded-xl bg-white p-6 shadow-lg">
      ...
      <div className="mt-6 rounded-lg bg-orange-50 p-4">
        ...
        <p className="text-sm text-orange-700">
          Este fenotipo se utilizará para buscar donantes compatibles con las características físicas deseadas.
          La clínica se encargará de encontrar el donante más adecuado según estos criterios.
        </p>
      </div>
    </div>
  );
