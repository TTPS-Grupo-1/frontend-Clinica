...
export default function HomePage() {
  ...
  const handleEmbriones = () => {
    navigate('/embriones');
    console.log('Navegando a gestión de embriones...');
  };
      ...
      <div className="relative z-10 px-4 pt-24 pb-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <article className="mx-auto grid max-w-6xl grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            {/* Card 5: Gestión de Embriones */}
            <div className="transition-transform duration-200 hover:-translate-y-1">
              <DashboardCard
                title="Gestión de Embriones"
                description="Consulta, edita y gestiona embriones registrados en el laboratorio."
                count={18}
                icon={
                  <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <circle
