...
export default function OrdenesMedicas() {
  ...
  if (loading) {
    return <div className="py-20 text-center text-blue-700">Cargando órdenes médicas...</div>;
  }
    ...
    <div className="relative mx-auto mt-16 min-h-screen w-full max-w-7xl overflow-x-hidden bg-gradient-to-br from-blue-100 via-white to-blue-300 px-4 py-6 sm:px-6 md:mt-20">
      ...
      <div className="relative z-10">
        <motion.div /* ... (Animación del header) */ className="mb-6">
          <h1 className="mb-2 text-center text-3xl font-bold text-blue-700 drop-shadow-lg">
            Órdenes Médicas
          </h1>
        ...
        {ordenes.length === 0 ? (
          <p className="mt-10 text-center text-gray-500">
            No hay órdenes médicas disponibles para descargar.
          </p>
        ) : (
          <motion.div
            /* ... (Animación del grid) */ className="grid grid-cols-1 gap-8 p-4 sm:grid-cols-2 lg:grid-cols-3"
          >
