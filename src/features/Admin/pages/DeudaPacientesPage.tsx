            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-blue-600">
                  <tr>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-white">Paciente</th>
                  ...
                  {pacientes.map((p) => {
                    ...
                    return (
                      <tr key={p.id} className="hover:bg-gray-50 transition">
                        ...
                        <td className="px-6 py-4 text-right text-sm text-red-800 font-semibold">
