...
const GenerarAgenda = () => {
  ...
  const handleGenerarGrilla = async () => {
    ...
    try {
      ...
      toast.success(`Grilla generada: ${successData.summary.insertados_ok} turnos creados.`, {
        duration: 6000,
      });
        ...
        <div className="mx-auto max-w-3xl">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Genera grillas de turnos periódicas para un médico
            </p>
          </div>

          <Toaster position="top-center" />

          <div className="w-full space-y-6 rounded-2xl bg-white p-6 shadow-md">
            ...
            <div>
              <label className="mb-2 block text-sm font-medium">Día de la Semana</label>
              <select
                value={diaSemana}
            ...
            {/* 3. Horario de Inicio */}
            <div>
              <label className="mb-2 block text-sm font-medium">Hora de Inicio (HH:MM)</label>
              <input
                type="time"
                value={horaInicio}
            ...
            {/* 4. Horario de Fin */}
            <div>
              <label className="mb-2 block text-sm font-medium">Hora de Fin (HH:MM)</label>
              <input
                type="time"
                value={horaFin}
            ...
            <button
              ...
              className={`mx-auto flex w-full items-center justify-center gap-2 rounded-md px-6 py-2 font-medium transition ${
                loading
