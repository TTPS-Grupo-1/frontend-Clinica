...
export default function TreatmentsList({
  ...
  return (
    <>
      ...
      {pacienteId && loading && <div className="text-gray-500">Cargando tratamientos...</div>}
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          {tratamientos.map((t: any) => (
            <button
              ...
              className="cursor-pointer rounded-lg border bg-white p-4 text-left hover:shadow"
            >
