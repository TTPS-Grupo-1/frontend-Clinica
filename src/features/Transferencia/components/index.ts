export { default as PacienteSelector } from './PacienteSelector';
export { default as TransferenciaSelector } from './TransferenciaSelector';
export { default as TransferenciaForm } from './TransferenciaForm';
